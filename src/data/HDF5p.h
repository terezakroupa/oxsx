...
#ifndef __OXSX_HDF5__
#define __OXSX_HDF5__
#include <string>
#include <vector>
...
class HDF5{
 public:
    ...
    static void SaveHistogram(const Histogram& hist_, const std::string& filename);
    static Histogram LoadHistogram(const std::string& filename);
