...
class HistTools{
    ...
    static void FillAllHists(std::map<std::string, Histogram>&,
														 const std::map<std::string, double>& fillvals);
    ...
    //private:
		//static void Combs(size_t, std::vector< std::vector<size_t> >, std::vector<size_t>, std::vector<size_t>);
